    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.ManyToManyField(to='codegnan.Answer')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assignmentFile', models.FileField(upload_to=codegnan.models.get_assignment_dir)),
            ],
        ),
        migrations.CreateModel(
            name='ConcurrentUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, upload_to=codegnan.models.get_upload_dir)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fixed_questions', models.ManyToManyField(to='codegnan.Question')),
            ],
        ),
        migrations.CreateModel(
            name='QuestionSet',
            fields=[
                ...
                ('questions', models.ManyToManyField(to='codegnan.Question')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ...
                ('prerequisite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='codegnan.Quiz')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HookTestCase',
            fields=[
                ('testcase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='codegnan.TestCase')),
        ...
        migrations.AddField(
            model_name='testcase',
            name='question',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='questionpaper',
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codegnan.Quiz'),
        ),
        migrations.AddField(
            model_name='questionpaper',
            name='random_questions',
            field=models.ManyToManyField(to='codegnan.QuestionSet'),
        ),
        migrations.AddField(
            model_name='fileupload',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question', to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='assignmentupload',
            name='assignmentQuestion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='assignmentupload',
            name='user',
        ...
        migrations.AddField(
            ...
            name='question_paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codegnan.QuestionPaper'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions_answered',
            field=models.ManyToManyField(related_name='questions_answered', to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions_unanswered',
            field=models.ManyToManyField(related_name='questions_unanswered', to='codegnan.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='user',
