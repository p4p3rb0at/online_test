...
from codegnan.views import add_as_moderator, course_forum, post_comments
from codegnan.forms import PostForm, CommentForm
from codegnan.decorators import user_has_profile
...
class TestProfile(TestCase):
    ...
    def test_view_profile_denies_anonymous(self):
        ...
        """
        response = self.client.get(reverse('codegnan:view_profile'), follow=True)
    ...
    def test_view_profile_get_for_user_without_profile(self):
        ...
        response = self.client.get(reverse('codegnan:view_profile'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/editprofile.html')
    ...
    def test_view_profile_get_for_user_with_profile(self):
        ...
        response = self.client.get(reverse('codegnan:view_profile'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/view_profile.html')
    ...
    def test_edit_profile_post(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/profile_updated.html')
    ...
    def test_edit_profile_get(self):
        ...
        response = self.client.get(reverse('codegnan:edit_profile'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/editprofile.html')
    ...
    def test_update_email_for_user_post(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/activation_status.html')
...
class TestStudentDashboard(TestCase):
    ...
    def test_student_dashboard_denies_anonymous_user(self):
        ...
        """
        response = self.client.get(reverse('codegnan:quizlist_user'),
                                   follow=True
                                   )
        self.assertEqual(response.status_code, 200)
    ...
    def test_student_dashboard_get_for_user_with_profile(self):
        ...
        response = self.client.get(reverse('codegnan:quizlist_user'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/quizzes_user.html')
    ...
    def test_student_dashboard_hidden_courses_post(self):
        ...
        response = self.client.post(reverse('codegnan:quizlist_user'),
...
class TestMonitor(TestCase):
    ...
    def test_monitor_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:monitor'),
                                   follow=True
                                   )
    ...
    def test_monitor_display_quiz_results(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "codegnan/monitor.html")
    ...
    def test_get_quiz_user_data(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/user_data.html')
...
class TestGradeUser(TestCase):
    ...
    def test_grade_user_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:grade_user'),
                                   follow=True
                                   )
        self.assertEqual(response.status_code, 404)
    ...
    def test_grade_user_display_quizzes(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "codegnan/grade_user.html")
    ...
    def test_grade_user_update_user_marks(self):
        ...
        self.client.get(reverse('codegnan:grade_user',
                                kwargs={"quiz_id": self.quiz.id,
                                        "course_id": self.course.id,
                                        "user_id": self.student.id}),
                        follow=True
...
class TestDownloadAssignment(TestCase):
    ...
    def test_download_assignment_denies_student(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_quiz_assignment',
                    kwargs={'quiz_id': self.quiz.id,
                            "course_id": self.course.id}),
            follow=True
            )
    ...
    def test_download_assignment_per_user(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_user_assignment',
                    kwargs={'quiz_id': self.quiz.id,
...
class TestAddQuiz(TestCase):
    ...
    def test_add_quiz_denies_anonymous(self):
        ...
        """
        response = self.client.get(
            reverse('codegnan:add_quiz', kwargs={
                'course_id': self.course.id,
    ...
    def test_add_quiz_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/add_quiz.html')
    ...
    def test_add_quiz_post_existing_quiz(self):
        ...
        tzone = pytz.timezone('UTC')
        response = self.client.post(
            reverse('codegnan:edit_quiz', kwargs={
                'course_id': self.course.id,
                'module_id': self.module.id,
    ...
    def test_add_exercise_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/add_exercise.html')
        self.assertIsNotNone(response.context['form'])
    ...
    def test_add_exercise_post_existing_exercise(self):
        ...
        response = self.client.post(
            reverse('codegnan:edit_exercise', kwargs={
                'course_id': self.course.id,
                'module_id': self.module.id,
    ...
    def test_add_exercise_post_new_exercise(self):
        ...
        response = self.client.post(
            reverse('codegnan:add_exercise', kwargs={
                'course_id': self.course.id,
                'module_id': self.module.id
            }),
            data={
...
class TestToggleModerator(TestCase):
    ...
    def test_toggle_for_moderator(self):
        ...
        response = self.client.get(
            reverse('codegnan:toggle_moderator')
        )
...
class TestAddTeacher(TestCase):
    ...
    def test_add_teacher_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/addteacher.html')
...
class TestRemoveTeacher(TestCase):
    ...
    def test_remove_teacher_denies_anonymous(self):
        ...
        """
        response = self.client.get(
            reverse('codegnan:remove_teacher',
                    kwargs={'course_id': self.course.id}
                    ),
            follow=True
        )
...
class TestCourses(TestCase):
    ...
    def test_courses_denies_anonymous(self):
        ...
        If not logged in redirect to login page
        """
        response = self.client.get(reverse('codegnan:courses'), follow=True)
    ...
    def test_courses_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/courses.html')
    ...
    def test_teacher_can_design_course(self):
        ...
        response = self.client.post(
            reverse('codegnan:design_course',
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/design_course_session.html')
    ...
    def test_get_course_modules(self):
        ...
        response = self.client.get(
            reverse('codegnan:course_modules',
                    kwargs={"course_id": self.user1_course.id}),
            follow=True
        )
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "codegnan/course_modules.html")
    ...
    def test_duplicate_course(self):
        ...
        response = self.client.get(
            reverse('codegnan:duplicate_course',
    ...
    def test_download_course_offline(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_course',
                    kwargs={"course_id": self.user1_course.id}),
            follow=True
        )
        self.assertEqual(response.status_code, 404)
...
class TestAddCourse(TestCase):
    ...
    def test_add_course_denies_anonymous(self):
        ...
        If not logged in redirect to login page
        """
        response = self.client.get(reverse('codegnan:add_course'),
                                   follow=True
                                   )
    ...
    def test_add_course_denies_non_moderator(self):
        ...
        response = self.client.get(reverse('codegnan:add_course'), follow=True)
        self.assertEqual(response.status_code, 404)
    ...
    def test_add_course_get(self):
        ...
        response = self.client.get(reverse('codegnan:add_course'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/add_course.html')
        self.assertIsNotNone(response.context['form'])
...
class TestCourseDetail(TestCase):
    ...
    def test_course_detail_denies_anonymous(self):
        ...
        """
        response = self.client.get(
            reverse('codegnan:course_detail',
                    kwargs={'course_id': self.user1_course.id}
                    ),
            follow=True
        )
    ...
    def test_course_detail_get(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/course_detail.html')
    ...
    def test_student_course_enroll_post(self):
        ...
        url = reverse('codegnan:enroll_reject_user', kwargs={
    ...
    def test_enroll_user_not_moderator(self):
        ...
        url = reverse('codegnan:enroll_user', kwargs={
            'course_id': self.user1_course.id,
    ...
    def test_reject_user_not_moderator(self):
        ...
        url = reverse('codegnan:reject_user', kwargs={
            'course_id': self.user1_course.id,
            'user_id': self.user1.id
        })
        response = self.client.post(url)
    ...
    def test_toggle_course_status_get(self):
        ...
        response = self.client.post(
            reverse('codegnan:toggle_course_status',
                    kwargs={'course_id': self.user1_course.id})
            )
        self.assertEqual(response.status_code, 302)
    ...
    def test_send_mail_to_course_students(self):
        ...
        self.client.post(reverse(
            'codegnan:send_mail', kwargs={'course_id': self.user1_course.id}),
            data=email_data
        )
    ...
    def test_download_users_template(self):
        ...
        response = self.client.get(reverse('codegnan:download_sample_csv'))
        self.assertEqual(response.status_code, 404)
    ...
    def test_view_course_status(self):
        ...
        response = self.client.get(reverse('codegnan:course_status',
                                   kwargs={'course_id': self.user1_course.id}))
        self.assertEqual(response.status_code, 404)
    ...
    def test_course_status_per_user(self):
        ...
        # Denies student to view course status
        response = self.client.get(reverse('codegnan:get_user_data',
                                   kwargs={'course_id': self.user1_course.id,
...
class TestCourseStudents(TestCase):
    ...
    def test_enrolled_users(self):
        ...
        url = reverse('codegnan:course_detail', kwargs={
            'course_id': self.user1_course.id
        })
        response = self.client.get(url)
...
class TestEnrollRequest(TestCase):
    ...
    def test_enroll_request_denies_anonymous(self):
        ...
        """
        response = self.client.get(
            reverse('codegnan:enroll_request',
                    kwargs={'course_id': self.course.id}
                    ),
            follow=True
        )
...
class TestViewAnswerPaper(TestCase):
    ...
    def test_anonymous_user(self):
        ...
        # When
        response = self.client.get(
            reverse('codegnan:view_answerpaper',
    ...
    def test_can_view_answerpaper(self):
        ...
        self.assertTemplateUsed(response, 'codegnan/view_answerpaper.html')
...
class TestGrader(TestCase):
    ...
    def test_regrade_denies_anonymous(self):
        ...
        # When
        response = self.client.get(
            reverse('codegnan:regrade_by_question',
                    kwargs={'course_id': self.course.id,
                            'questionpaper_id': self.question_paper.id,
                            'question_id': self.question.id,
    ...
    def test_regrade_by_moderator(self):
        ...
        # When
        response = self.client.get(
            reverse('codegnan:regrade_by_user',
                    kwargs={'course_id': self.course.id,
                            'questionpaper_id': self.question_paper.id,
                            'answerpaper_id': self.answerpaper.id}),
            follow=True)
        ...
        # When
        response = self.client.get(
            reverse('codegnan:regrade_by_quiz',
                    kwargs={'course_id': self.course.id,
                            'question_id': self.question.id,
                            'questionpaper_id': self.question_paper.id}),
            follow=True)
...
class TestModeratorDashboard(TestCase):
    ...
    def test_moderator_dashboard_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:manage'),
                                   follow=True
                                   )
        self.assertEqual(response.status_code, 200)
    ...
    def test_moderator_dashboard_get_all_quizzes(self):
        ...
        response = self.client.get(reverse('codegnan:manage'), follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "codegnan/moderator_dashboard.html")
...
class TestUserLogin(TestCase):
    ...
    def test_unsuccessful_user_login(self):
        ...
        """
        response = self.client.post(reverse('codegnan:login'),
                                    data={'username': self.user1.username,
                                          'password': "demo"}
                                    )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/login.html')
...
class TestDownloadCsv(TestCase):
    ...
    def test_download_csv_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:download_quiz_csv',
                                   kwargs={"course_id": self.course.id,
                                           "quiz_id": self.quiz.id}),
                                   follow=True
                                   )
    ...
    def test_download_course_csv_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:download_course_csv',
                                   kwargs={"course_id": self.course.id}),
                                   follow=True
                                   )
        self.assertEqual(response.status_code, 404)
    ...
    def test_download_course_csv(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_course_csv',
                    kwargs={'course_id': self.course.id}),
            follow=True
            )
    ...
    def test_download_course_progress_csv(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_course_progress',
                    kwargs={'course_id': self.course.id}),
            follow=True
            )
        file_name = "{0}.csv".format(
    ...
    def test_download_quiz_csv(self):
        ...
        response = self.client.post(
            reverse('codegnan:download_quiz_csv',
                    kwargs={"course_id": self.course.id,
                            "quiz_id": self.quiz.id}),
...
class TestShowQuestions(TestCase):
    ...
    def test_show_questions_denies_student(self):
        ...
        response = self.client.get(reverse('codegnan:show_questions'),
                                   follow=True
                                   )
        self.assertEqual(response.status_code, 404)
    ...
    def test_show_all_questions(self):
        ...
        response = self.client.get(
            reverse('codegnan:show_questions'), follow=True
            )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/showquestions.html')
    ...
    def test_download_questions(self):
        ...
        response = self.client.post(
            reverse('codegnan:show_questions'),
    ...
    def test_questions_filter(self):
        ...
        response = self.client.get(
            reverse('codegnan:questions_filter'),
    ...
    def test_download_question_yaml_template(self):
        ...
        response = self.client.get(reverse('codegnan:download_yaml_template'))
        self.assertEqual(response.status_code, 404)
    ...
    def test_search_tags(self):
        ...
        response = self.client.get(
                reverse('codegnan:search_questions_by_tags'),
    ...
    def test_single_question_attempt(self):
        ...
        response = self.client.get(
            reverse('codegnan:test_question', args=[self.question.id])
            )
        trial_que_paper = QuestionPaper.objects.get(
                                            quiz__description="trial_questions"
                                            )
    ...
    def test_single_question_download(self):
        ...
        response = self.client.get(
            reverse('codegnan:download_question', args=[self.question.id])
            )
    ...
    def test_single_question_delete(self):
        ...
        response = self.client.get(
            reverse('codegnan:delete_question', args=[self.question.id])
            )
        self.assertEqual(response.status_code, 302)
        updated_que = Question.objects.get(id=self.question.id)
        self.assertFalse(updated_que.active)
...
class TestShowStatistics(TestCase):
    ...
    def test_show_statistics_denies_student(self):
        ...
        response = self.client.get(
            reverse('codegnan:show_statistics',
                    kwargs={"questionpaper_id": self.question_paper.id,
                            "course_id": self.course.id}),
            follow=True
            )
    ...
    def test_show_statistics_for_student(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/statistics_question.html')
        self.assertEqual(response.context['quiz'], self.quiz)
...
class TestQuestionPaper(TestCase):
    ...
    def test_preview_questionpaper_correct(self):
        ...
        response = self.client.get(
            reverse('codegnan:preview_questionpaper',
                    kwargs={"questionpaper_id": self.question_paper.id}
                    )
            )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/preview_questionpaper.html')
        self.assertEqual(
    ...
    def test_design_questionpaper(self):
        ...
        response = self.client.get(
            reverse('codegnan:designquestionpaper',
                    kwargs={
                        "course_id": self.course.id,
        ...
        response = self.client.get(
            reverse('codegnan:designquestionpaper',
                    kwargs={"quiz_id": self.quiz.id,
                            ...
                            "questionpaper_id": self.question_paper.id}))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/design_questionpaper.html')
...
class TestLearningModule(TestCase):
    ...
    def test_add_new_module_denies_non_moderator(self):
        ...
        response = self.client.post(
            reverse('codegnan:add_module', kwargs={"course_id": self.course.id}),
    ...
    def test_teacher_can_design_module(self):
        ...
        response = self.client.post(
            reverse('codegnan:design_module',
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'codegnan/add_module.html')
        ...
        response = self.client.get(
            reverse('codegnan:view_module',
                    kwargs={"module_id": self.learning_module.id,
                            "course_id": self.course.id}))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "codegnan/show_video.html")
...
class TestPost(TestCase):
    ...
    def test_csrf(self):
        ...
        self.course.students.add(self.student)
        url = reverse('codegnan:course_forum', kwargs={
            'course_id': self.course.id
        })
        response = self.client.get(url)
    ...
    def test_view_course_forum(self):
        ...
        self.assertTemplateUsed(response, 'codegnan/course_forum.html')
    ...
    def test_course_forum_contains_link_to_post_comments_page(self):
        ...
        response = self.client.get(url)
        post_comments_url = reverse('codegnan:post_comments', kwargs={
            'course_id': self.course.id,
            'uuid': post.uid
        })
    ...
    def test_open_created_post_denies_anonymous_user(self):
        ...
        url = reverse('codegnan:post_comments', kwargs={
            'course_id': self.course.id,
            'uuid': post.uid
        })
        response = self.client.get(url, follow=True)
    ...
    def test_hide_post(self):
        ...
        url = reverse('codegnan:hide_post', kwargs={
            'course_id': self.course.id,
            'uuid': post.uid
        })
        response = self.client.get(url, follow=True)
...
class TestPostComment(TestCase):
    ...
    def test_post_comments_view_contains_link_back_to_course_forum_view(self):
        ...
        self.course.students.add(self.student)
        comment_url = reverse('codegnan:post_comments', kwargs={
            'course_id': self.course.id,
            'uuid': self.post.uid
        })
        course_forum_url = reverse('codegnan:course_forum', kwargs={
            'course_id': self.course.id
        })
    ...
    def test_hide_post_comment(self):
        ...
        url = reverse('codegnan:hide_comment', kwargs={
            'course_id': self.course.id,
            'uuid': comment.uid
        })
        response = self.client.get(url)
...
class TestStartExam(TestCase):
    ...
    def test_start_question_paper_does_not_exists_for_user(self):
        ...
        url = reverse('codegnan:start_quiz', kwargs={
            'questionpaper_id': 99,
...
class TestLessonContents(TestCase):
    ...
    def test_add_lesson_topic(self):
        ...
        # delete topic Toc
        response = self.client.post(
            reverse('codegnan:delete_toc',
                    kwargs={"course_id": self.user1_course1.id,
                            "toc_id": toc.id}),
            data={'redirect_url': reverse("codegnan:login")}
            )
        self.assertEqual(response.status_code, 302)
    ...
    def test_add_lesson_quiz(self):
        ...
        # disallow user other than moderator or course creator or course teacher
        response = self.client.post(
            reverse('codegnan:add_marker_quiz',
                    kwargs={"content_type": '1',
                            "course_id": self.user1_course1.id,
                            "lesson_id": self.lesson1.id}),
        ...
        response = self.client.get(
            reverse('codegnan:edit_marker_quiz',
                    kwargs={"content_type": '2',
                            "course_id": self.user1_course1.id,
                            "lesson_id": self.lesson1.id,
    ...
    def test_get_and_submit_marker_quiz(self):
        ...
        # When
        response = self.client.get(
            reverse('codegnan:get_marker_quiz',
                    kwargs={"course_id": self.user1_course1.id,
                            "toc_id": toc.id})
            )
        ...
        response = self.client.post(
            reverse('codegnan:submit_marker_quiz',
                    kwargs={"course_id": self.user1_course1.id,
                            "toc_id": toc.id}),
            data={'answer': ''}
            )
    ...
    def test_lesson_statistics(self):
        ...
        response = self.client.get(
            reverse('codegnan:lesson_statistics',
                    kwargs={"course_id": self.user1_course1.id,
                            "lesson_id": self.lesson1.id})
            )
    ...
    def test_upload_download_lesson_contents(self):
        ...
        response = self.client.get(reverse('codegnan:download_sample_toc'))
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.get('Content-Disposition'),
