...
"""
from codegnan.pipeline.settings import AUTH_PIPELINE
import os
...
OUTPUT_DIR = os.path.join(BASE_DIR, "codegnan_data", "output")
...
MIDDLEWARE = (
    ...
    'codegnan.middleware.one_session_per_user.OneSessionPerUserMiddleware',
    'codegnan.middleware.get_notifications.NotificationMiddleware',
    'codegnan.middleware.user_time_zone.TimezoneMiddleware',
...
MEDIA_ROOT = os.path.join(BASE_DIR, "codegnan_data", "data")

STATIC_ROOT = 'codegnan/static/'
...
if USE_AWS:
    ...
    AWS_STORAGE_BUCKET_NAME = "codegnan-django"
    ...
    STATICFILES_STORAGE = 'codegnan.storage_backends.StaticStorage'
    STATIC_URL = f"https://{AWS_S3_CUSTOM_DOMAIN}/{AWS_STATIC_LOCATION}/"
    # Media Public
    AWS_PUBLIC_MEDIA_LOCATION = 'media/public'
    DEFAULT_FILE_STORAGE = 'codegnan.storage_backends.PublicMediaStorage'
