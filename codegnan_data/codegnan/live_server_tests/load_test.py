...
# Local imports
from codegnan.models import User, Profile, Course, create_group
from codegnan.code_server import ServerPool
from codegnan import settings
...
class YakshSeleniumTests(StaticLiveServerTestCase):
    ...
    def setUpClass(cls):
        ...
        settings.code_evaluators['c']['standardtestcase'] = \
            "codegnan.cpp_code_evaluator.CppCodeEvaluator"
        settings.code_evaluators['bash']['standardtestcase'] = \
            "codegnan.bash_code_evaluator.BashCodeEvaluator"
