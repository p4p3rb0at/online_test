...
from codegnan.code_server import get_result as get_result_from_code_server
...
from codegnan.settings import SERVER_POOL_PORT, SERVER_HOST_NAME
        ...
        if form.is_valid():
            ...
            if user_email and key:
                ...
                return my_render_to_response(
                    request,
                    'codegnan/activation_status.html', context
                )
            return index(request)
        else:
            return my_render_to_response(
                request, 'codegnan/register.html', {'form': form}
            )
    else:
...
def user_logout(request):
    ...
    return my_render_to_response(request, 'codegnan/complete.html', context)
...
def quizlist_user(request, enrolled=None, msg=None):
    ...
    return my_render_to_response(request, "codegnan/quizzes_user.html", context)
...
def results_user(request):
    ...
    return my_render_to_response(request, "codegnan/results_user.html", context)
...
def add_question(request, question_id=None):
    ...
    if request.method == 'POST':
        ...
        if qform.is_valid():
            ...
            return render(request, "codegnan/add_question.html", context)
...
def add_quiz(request, course_id=None, module_id=None, quiz_id=None):
    ...
    context["quiz"] = quiz
    context["form"] = form
    return my_render_to_response(request, 'codegnan/add_quiz.html', context)
...
def add_exercise(request, course_id=None, module_id=None, quiz_id=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                reverse("codegnan:edit_exercise",
    ...
    context["course_id"] = course_id
    context["form"] = form
    return my_render_to_response(request, 'codegnan/add_exercise.html', context)
...
def prof_manage(request, msg=None):
    ...
    return my_render_to_response(
        request, 'codegnan/moderator_dashboard.html', context
    )
...
def user_login(request):
    ...
    return my_render_to_response(request, 'codegnan/login.html', context)
...
def start(request, questionpaper_id=None, attempt_num=None, course_id=None,
    ...
    if attempt_num is None and not quest_paper.quiz.is_exercise:
        ...
        return my_render_to_response(request, 'codegnan/intro.html', context)
    else:
        ip = request.META['REMOTE_ADDR']
...
def show_question(request, question, paper, error_message=None,
    ...
    return my_render_to_response(request, 'codegnan/question.html', context)
...
def quit(request, reason=None, attempt_num=None, questionpaper_id=None,
    ...
    context = {'paper': paper, 'message': reason, 'course_id': course_id,
               'module_id': module_id}
    return my_render_to_response(request, 'codegnan/quit.html', context)
...
def add_course(request, course_id=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return my_render_to_response(
                request, 'codegnan/add_course.html', {'form': form}
            )
    else:
...
def courses(request):
    ...
    return my_render_to_response(request, 'codegnan/courses.html', context)
...
def course_detail(request, course_id):
    ...
    return my_render_to_response(request, 'codegnan/course_detail.html', context)
...
def enroll_user(request, course_id, user_id=None, was_rejected=False):
    ...
    if not course.is_active_enrollment():
        ...
        messages.warning(request, msg)
        return redirect('codegnan:course_detail', course_id=course_id)
...
def show_statistics(request, questionpaper_id, attempt_number=None,
    ...
    if attempt_number is None:
        return my_render_to_response(
            request, 'codegnan/statistics_question.html', context
        )
...
def monitor(request, quiz_id=None, course_id=None, attempt_number=1):
    ...
    return my_render_to_response(request, 'codegnan/monitor.html', context)
...
def design_questionpaper(request, course_id, quiz_id, questionpaper_id=None):
    ...
    return my_render_to_response(
        request, 'codegnan/design_questionpaper.html', context
    )
...
def show_all_questions(request):
    ...
    messages.info(request, message)
    return my_render_to_response(request, 'codegnan/showquestions.html', context)
...
def questions_filter(request):
    ...
    return my_render_to_response(
        request, 'codegnan/showquestions.html', context
    )
...
def delete_question(request, question_id):
    ...
    return my_redirect(reverse("codegnan:show_questions"))
...
def user_data(request, user_id, questionpaper_id=None, course_id=None):
    ...
    return my_render_to_response(request, 'codegnan/user_data.html', context)
...
def grade_user(request, quiz_id=None, user_id=None, attempt_number=None,
    ...
    return my_render_to_response(request, 'codegnan/grade_user.html', context)
...
def view_profile(request):
    ...
    return my_render_to_response(request, 'codegnan/view_profile.html', context)
...
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form_data.user.save()
            form_data.save()
            return my_render_to_response(request, 'codegnan/profile_updated.html')
        else:
            context['form'] = form
            return my_render_to_response(
                request, 'codegnan/editprofile.html', context
            )
    else:
...
def test_quiz(request, mode, quiz_id, course_id=None):
    ...
    if (quiz.is_expired() or not quiz.active) and not godmode:
        ...
        return my_redirect(reverse("codegnan:index"))
...
def view_answerpaper(request, questionpaper_id, course_id):
    ...
    if quiz.view_answerpaper and user in course.students.all():
        ...
        context = {'data': data, 'quiz': quiz, 'course_id': course.id,
                   "has_user_assignments": has_user_assignments}
        return my_render_to_response(
            request, 'codegnan/view_answerpaper.html', context
        )
    else:
        return my_redirect('/exam/quizzes/')
...
def regrade(request, course_id, questionpaper_id, question_id=None,
    ...
    if is_celery_alive:
        ...
        messages.warning(request, msg)
    return redirect(
        reverse("codegnan:grade_user", args=[quiz.id, course_id])
    )
...
def activate_user(request, key):
    ...
    if profile.is_email_verified:
        ...
        return my_render_to_response(
            request, 'codegnan/activation_status.html', context
        )
...
def upload_users(request, course_id):
    ...
    if request.method == 'POST':
        if 'csv_file' not in request.FILES:
            ...
            return my_redirect(reverse('codegnan:course_detail',
                                       args=[course_id]))
    ...
    return my_redirect(reverse('codegnan:course_detail', args=[course_id]))
...
def duplicate_course(request, course_id):
    ...
    if course.is_teacher(user) or course.is_creator(user):
        ...
        messages.warning(request, msg)
    return my_redirect(reverse('codegnan:courses'))
...
def edit_lesson(request, course_id=None, module_id=None, lesson_id=None):
    ...
    context['course_id'] = course_id
    return my_render_to_response(request, 'codegnan/add_lesson.html', context)
...
def show_lesson(request, lesson_id, module_id, course_id):
    ...
    return my_render_to_response(request, 'codegnan/show_video.html', context)
...
def design_module(request, module_id, course_id=None):
    ...
    return my_render_to_response(request, 'codegnan/add_module.html', context)
...
def design_course(request, course_id):
    ...
    return my_render_to_response(
        request, 'codegnan/course_detail.html', context
    )
...
def course_modules(request, course_id, msg=None):
    ...
    return my_render_to_response(request, 'codegnan/course_modules.html', context)
...
def preview_questionpaper(request, questionpaper_id):
    ...
    return my_render_to_response(
        request, 'codegnan/preview_questionpaper.html', context
    )
...
def get_user_data(request, course_id, student_id):
    ...
    template_path = os.path.join(
        os.path.dirname(__file__), "templates", "codegnan", "user_status.html"
        )
    with open(template_path) as f:
        template_data = f.read()
        template = Template(template_data)
...
def view_notifications(request):
    ...
    return my_render_to_response(
        request, 'codegnan/view_notifications.html', context
    )
...
def mark_notification(request, message_uid=None):
    ...
    return redirect(reverse("codegnan:view_notifications"))
...
def course_forum(request, course_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('codegnan:post_comments',
                            course_id=course.id, uuid=new_post.uid)
    else:
        form = PostForm()
    return render(request, 'codegnan/course_forum.html', {
        'user': user,
        'course': course,
...
def lessons_forum(request, course_id):
    ...
    return render(request, 'codegnan/lessons_forum.html', {
        'user': user,
        'base_template': base_template,
        'moderator': moderator,
        'course': course,
...
def post_comments(request, course_id, uuid):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(request.path_info)
    return render(request, 'codegnan/post_comments.html', {
        'post': post,
        'comments': comments,
        'base_template': base_template,
        'form': form,
...
def hide_post(request, course_id, uuid):
    ...
    return redirect('codegnan:course_forum', course_id)
...
def hide_comment(request, course_id, uuid):
    ...
    return redirect('codegnan:post_comments', course_id, post_uid)
...
def add_marker(request, course_id, lesson_id):
    ...
    if content_type == '1':
        form = TopicForm()
        template_name = 'codegnan/add_topic.html'
        status = 1
        formset = None
        tc_class = None
    else:
        ...
        template_name = 'codegnan/add_video_quiz.html'
        status = 2
...
def get_toc_contents(request, course_id, lesson_id):
    ...
    data = loader.render_to_string(
        "codegnan/show_toc.html", context={
...
def allow_special_attempt(request, user_id, course_id, quiz_id):
    ...
    messages.info(request, msg)
    return redirect('codegnan:monitor', quiz_id, course_id)
...
def add_topic(request, content_type, course_id, lesson_id, toc_id=None,
    ...
    if request.method == "POST":
        ...
        data = loader.render_to_string(
            "codegnan/add_topic.html", context=template_context, request=request
        )
        context['success'] = True
        context['data'] = data
...
def add_marker_quiz(request, content_type, course_id, lesson_id,
    ...
    if request.method == "POST":
        ...
        data = loader.render_to_string(
            "codegnan/add_video_quiz.html", context=template_context,
            request=request
        )
        context['success'] = True
        context['data'] = data
...
def revoke_special_attempt(request, micromanager_id):
    ...
    messages.info(request, msg)
    return redirect(
        'codegnan:monitor', micromanager.quiz.id, course.id)
...
def extend_time(request, paper_id):
    ...
    messages.info(request, msg)
    return redirect(
        'codegnan:monitor', anspaper.question_paper.quiz.id, course.id
    )
...
def get_marker_quiz(request, course_id, toc_id):
    ...
    data = loader.render_to_string(
        "codegnan/show_lesson_quiz.html", context=template_context,
        request=request
    )
...
def lesson_statistics(request, course_id, lesson_id, toc_id=None):
    ...
    return render(request, 'codegnan/show_lesson_statistics.html', context)
...
def upload_marks(request, course_id, questionpaper_id):
    ...
    if request.method == 'POST':
        if 'csv_file' not in request.FILES:
            messages.warning(request, "Please upload a CSV file.")
            return redirect('codegnan:monitor', quiz.id, course_id)
        csv_file = request.FILES['csv_file']
        is_csv_file, dialect = is_csv(csv_file)
        if not is_csv_file:
            messages.warning(request, "The file uploaded is not a CSV file.")
...
def generate_qrcode(request, answerpaper_id, question_id, module_id):
    ...
    if not qrcode.is_qrcode_available():
        content = request.build_absolute_uri(
            reverse("codegnan:upload_file", args=[qrcode.short_key])
        )
        qrcode.generate_image(content)
    return redirect(
        reverse(
            'codegnan:skip_question',
...
def upload_file(request, key):
    ...
    if not handler.can_use():
        ...
        return render(request, 'codegnan/upload_file.html', context)
    if request.method == 'POST':
        assign_files = []
        assignments = request.FILES
        for i in range(len(assignments)):
...
def upload_download_course_md(request, course_id):
    ...
    if request.method == "POST":
        ...
        return redirect(
            'codegnan:course_detail', course.id
        )
    else:
        context = {
            'course': course,
