...
# Local Imports
from codegnan.models import User, Course, Quiz, TableOfContents, Lesson
...
@register.inclusion_tag('codegnan/micromanaged.html')
...
@register.inclusion_tag('codegnan/micromonitor.html')
